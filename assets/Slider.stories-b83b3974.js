import{r as c,e as a,s as R}from"./iframe-22864007.js";import{B as b}from"./index-71c111d9.js";import{T as v}from"./index-223a013d.js";import{u as I,a as M,C as q}from"./useSlider-148c86d1.js";import"./index.esm-ed4e9270.js";import"./SpacingStyles-a9a54458.js";import"./TextStyles-7697a8a1.js";import"./helpers-4992d6b4.js";import"./Color-0aa54fb0.js";import"./Sizing-35dbcd46.js";import"./useFormControl-ca195f92.js";import"./check-9c2d93e5.js";import"./index-3434f921.js";import"./rtl-a2dddcc3.js";import"./index-15f66ba7.js";import"./_arrayPush-9092d65c.js";const g=({testId:s="MultiSlider",px:u,disabled:t,...n})=>{const l=I(n.value),[r,i]=M(n.value,n,l);return c.useEffect(()=>{!r||!r.current||(r.current.on("update",()=>{var m;const e=(m=r.current)==null?void 0:m.get();Array.isArray(e)&&n.onChange(e)}),r.current.on("change",()=>{var m;const e=(m=r.current)==null?void 0:m.get();n.onRelease&&Array.isArray(e)&&n.onRelease(e)}))},[r]),a.createElement(q,{className:n.className,testId:s,sliderRef:i,sliderApi:r.current,disabled:t,px:u})};g.__docgenInfo={description:"",methods:[],displayName:"MultiSlider",props:{range:{required:!0,tsType:{name:"signature",type:"object",raw:`{
	min: SubRange
	max: SubRange
	[key: string]: SubRange
