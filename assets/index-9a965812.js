import{U as r,s as t,e as a}from"./iframe-a6e3c2ce.js";import{i as p}from"./Sizing-35dbcd46.js";import{a as u}from"./colors-3cc0579a.js";import{m as l}from"./SpacingStyles-3c7442ac.js";const i=(e,n)=>p(e)?n.tokens.spinner.sizing[e]:typeof e=="number"?`${e}px`:e,c=r`
	100% {
...
`,d=t.div`
	...
	animation: 0.86s cubic-bezier(0.4, 0.15, 0.6, 0.85) 0ms infinite normal none
		running ${c};
	height: ${({theme:e,size:n})=>i(n,e)};
	width: ${({theme:e,size:n})=>i(n,e)};
	display: inline-flex;
