import{r as c,e as a,s as R}from"./iframe-967d279e.js";import{B as b}from"./index-52e8b132.js";import{T as v}from"./index-92673e72.js";import{u as I,a as M,C as q}from"./useSlider-45b95ec3.js";import"./index.esm-55c8321e.js";import"./SpacingStyles-2ec446a3.js";import"./TextStyles-74717613.js";import"./helpers-4992d6b4.js";import"./Color-0aa54fb0.js";import"./Sizing-35dbcd46.js";import"./useFormControl-b135524d.js";import"./check-9c2d93e5.js";import"./index-9fae1e2e.js";import"./rtl-f9a8c78b.js";import"./index-e1d7f538.js";import"./_arrayPush-74b3e82d.js";const g=({testId:s="MultiSlider",px:u,disabled:t,...n})=>{const l=I(n.value),[r,i]=M(n.value,n,l);return c.useEffect(()=>{!r||!r.current||(r.current.on("update",()=>{var m;const e=(m=r.current)==null?void 0:m.get();Array.isArray(e)&&n.onChange(e)}),r.current.on("change",()=>{var m;const e=(m=r.current)==null?void 0:m.get();n.onRelease&&Array.isArray(e)&&n.onRelease(e)}))},[r]),a.createElement(q,{className:n.className,testId:s,sliderRef:i,sliderApi:r.current,disabled:t,px:u})};g.__docgenInfo={description:"",methods:[],displayName:"MultiSlider",props:{range:{required:!0,tsType:{name:"signature",type:"object",raw:`{
	min: SubRange
	max: SubRange
	[key: string]: SubRange
