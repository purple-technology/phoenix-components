import{r as c,e as a,s as R}from"./iframe-d0511029.js";import{B as b}from"./index-1ceb11b8.js";import{T as v}from"./index-ae4b74e4.js";import{u as I,a as M,C as q}from"./useSlider-f4da776d.js";import"./index.esm-f50a7405.js";import"./SpacingStyles-66d9a443.js";import"./TextStyles-a2f425cd.js";import"./helpers-4992d6b4.js";import"./Color-0aa54fb0.js";import"./Sizing-35dbcd46.js";import"./useFormControl-67ee0be8.js";import"./check-9c2d93e5.js";import"./index-d254163b.js";import"./rtl-bf1a4ec1.js";import"./index-65d923a3.js";import"./_arrayPush-0a938b26.js";const g=({testId:s="MultiSlider",px:u,disabled:t,...n})=>{const l=I(n.value),[r,i]=M(n.value,n,l);return c.useEffect(()=>{!r||!r.current||(r.current.on("update",()=>{var m;const e=(m=r.current)==null?void 0:m.get();Array.isArray(e)&&n.onChange(e)}),r.current.on("change",()=>{var m;const e=(m=r.current)==null?void 0:m.get();n.onRelease&&Array.isArray(e)&&n.onRelease(e)}))},[r]),a.createElement(q,{className:n.className,testId:s,sliderRef:i,sliderApi:r.current,disabled:t,px:u})};g.__docgenInfo={description:"",methods:[],displayName:"MultiSlider",props:{range:{required:!0,tsType:{name:"signature",type:"object",raw:`{
	min: SubRange
	max: SubRange
	[key: string]: SubRange
