import{r as c,e as a,s as R}from"./iframe-3d4a8e97.js";import{B as b}from"./index-347a1367.js";import{T as v}from"./index-3a2cd5c2.js";import{u as I,a as M,C as q}from"./useSlider-9aef0359.js";import"./index.esm-54c6838d.js";import"./SpacingStyles-4e27dfe9.js";import"./TextStyles-c551402b.js";import"./helpers-4992d6b4.js";import"./Color-0aa54fb0.js";import"./Sizing-35dbcd46.js";import"./useFormControl-e55d219d.js";import"./check-9c2d93e5.js";import"./index-7aec5f09.js";import"./rtl-e711b500.js";import"./index-1f0cdf82.js";import"./_arrayPush-37ca97f3.js";const g=({testId:s="MultiSlider",px:u,disabled:t,...n})=>{const l=I(n.value),[r,i]=M(n.value,n,l);return c.useEffect(()=>{!r||!r.current||(r.current.on("update",()=>{var m;const e=(m=r.current)==null?void 0:m.get();Array.isArray(e)&&n.onChange(e)}),r.current.on("change",()=>{var m;const e=(m=r.current)==null?void 0:m.get();n.onRelease&&Array.isArray(e)&&n.onRelease(e)}))},[r]),a.createElement(q,{className:n.className,testId:s,sliderRef:i,sliderApi:r.current,disabled:t,px:u})};g.__docgenInfo={description:"",methods:[],displayName:"MultiSlider",props:{range:{required:!0,tsType:{name:"signature",type:"object",raw:`{
	min: SubRange
	max: SubRange
	[key: string]: SubRange
