...
import { StyledUpload, PreviewFilesWrapper, FilePreview, UploadButton, SinglePreview, Remove, RelativeWrap, Error, Wrapper } from './FileUploadStyle';
...
const Upload = ({ label, dragInstructions, onFileDrop, acceptedFilePattern, uploadButtonText, onFileRemove, multiple, error }: UploadProps) => {
